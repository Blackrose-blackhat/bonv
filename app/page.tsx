  ...
  return (
    <main className="flex flex-col items-center justify-between min-h-screen">
      ...
      >
        <div className="bg-black opacity-75 w-full h-screen flex flex-col items-center justify-center text-white">
          <div className="flex flex-row">
            <h1 className="text-shadow font-bold text-xl lg:text-3xl mb-4 ">
              Support Bonv
            </h1>
          </div>
          <p className="text-3xl lg:text-6xl w-full lg:w-2/3 mt-10 font-light text-center py-5">
            Help us win this competition for India by casting your vote for
            Bonv.
          </p>
          <p className="mt-10 w-full lg:w-1/2 text-center text-xl ">
          ...
          <p className="mt-5 text-center w-full lg:w-2/3 text-lg lg:text-2xl ">
          ...
          <div className="py-10">
            <Link href="https://www.meetthedrapers.com/vote" target="_blank">
              <Button className="p-6 text-md lg:text-xl bg-blue-700">
                Go Vote for Bonv
              </Button>
            </Link>
          </div>
      ...
      <div id="video" className="py-5">
        <h2 className="p-5 underline text-xl lg:text-3xl font-semibold text-neutral-700">
      ...
      <div className="w-full p-5 lg:p-20">
        ...
        >
          <div className="bg-black opacity-90 w-full text-white h-screen flex flex-col items-center justify-center">
            <h1 className="text-4xl lg:text-6xl font-bold mt-20 lg:mt-96 ">
              Vote For BONV
            </h1>
            <p className="text-lg lg:text-xl font-thin mt-5 lg:mt-10 text-center w-full lg:w-1/2">
              Also, send the link{" "}
              <a
        ...
        <div>
          <div className="flex flex-col lg:flex-row w-full p-5 lg:py-20">
            <div className="lg:flex-1 ">
              <Image src={team} alt="team" quality={100} width={950} />
            </div>
            <div className="lg:flex-1 flex flex-col gap-10 lg:gap-40 items-center justify-center py-10 lg:py-20">
              <p className="text-center text-base lg:text-xl font-normal text-neutral-800">
                At{" "}
        ...
        <div className="w-full flex flex-row justify-center items-center p-5 lg:p-10">
          <iframe
            width="100%"
            height="515"
